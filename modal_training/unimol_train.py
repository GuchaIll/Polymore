...
if __name__ == "__main__":
    ...
    for target_name in ['Tg', 'Tc', 'Density', 'Rg']:
        ...
        # RESUMPTION LOGIC
        if os.path.exists(os.path.join(save_path, 'metric.result')):
            print(f"Skipping {target_name} - already completed.")
            continue
        ...
        trainer = MolTrain(
            ...
            save_path=save_path, # f'models/UniMol2_2025_09_07_TabM{PLACEHOLDER_ELEMENT_SUFFIX}/{target_name}',
        )

        data_path = f"uni_mol/unimol_datasets/extra_data_TabM/{target_name}.csv"
