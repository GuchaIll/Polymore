...
if __name__ == '__main__':
    ...
    for config_path in tqdm(config_paths):
        ...
        # RESUMPTION LOGIC
        model_path = f'simulations/models/xgb_{target_name}.joblib'
        if os.path.exists(model_path):
            print(f"Skipping {target_name} - model already exists.")
            # Still load or compute stats if we need pearson_rs for valid summary, 
            # but usually for production/inference we just need the files.
            continue
