...
def train_and_save_rankup(
    ...
    output_dir = f'models/{output_dir_suffix}_rankup'
...
def pretrain_modernbert():
    train_and_save_rankup(
        base_model_identifier = 'answerdotai/ModernBERT-base',
        context_pooler_hidden_size = 768,
        learning_rate = 8e-5,
        output_dir_suffix = 'modern_3epochs_2thresh_v2.1',
        epoch_count = 3,
        margin_std_fraction = 0.2,
        input_data_path = 'data/PI1M_pseudolabels/PI1M_50000_v2.1.csv',
        train_fraction = 0.85,
        random_state = 42,
        batch_size_train = 32,
        batch_size_valid = 64,
    ...
    train_and_save_rankup(
        ...
        context_pooler_hidden_size = 768,
        learning_rate = 8e-5,
        output_dir_suffix = 'modern_6epochs_2thresh_v2.1',
        epoch_count = 6,
        margin_std_fraction = 0.2,
        input_data_path = 'data/PI1M_pseudolabels/PI1M_50000_v2.1.csv',
        train_fraction = 0.85,
...
def pretrain_codebert():
    train_and_save_rankup(
        base_model_identifier = 'microsoft/codebert-base',
        context_pooler_hidden_size = 768,
        learning_rate = 8e-5,
        output_dir_suffix = 'code_3epochs_2thresh_v2.2',
        epoch_count = 3,
        margin_std_fraction = 0.2,
        input_data_path = 'data/PI1M_pseudolabels/PI1M_50000_v2.2.csv',
        train_fraction = 0.85,
        random_state = 42,
        batch_size_train = 32,
        batch_size_valid = 64,
    ...
    train_and_save_rankup(
        ...
        context_pooler_hidden_size = 768,
        learning_rate = 8e-5,
        output_dir_suffix = 'code_6epochs_2thresh_v2.2',
        epoch_count = 6,
        margin_std_fraction = 0.2,
        input_data_path = 'data/PI1M_pseudolabels/PI1M_50000_v2.2.csv',
        train_fraction = 0.85,
